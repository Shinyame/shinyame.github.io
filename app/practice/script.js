const words = [
   ...
   { word: 'send', mean: '～を送る（動詞）', translation: 'I can send my assignment by tomorrow.', example: '私は課題を明日までに送付できる。', answered: false },
   { word: 'beautiful', mean: '美しい（形容詞）', translation: 'She is a beautiful girl.', example: '彼女は美しい女の子だ。', answered: false },
   { word: 'song', mean: '歌（名詞）', translation: 'We sing a song every day.', example: '我々は毎日歌を歌う。', answered: false },
